...
public class VehicleRemoveFormController {
    ...
    public void VehicleRemoveOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        if (Validation.isAllValidated(validationList)){
            if ( new InsurenceController().deleteInsurence(txtInsurenceId.getText()) ) {
    ...
    private void setData(Vehicle v1, Insurence i) {
        ...
        txtInsurenceId.setText(i.getInsurenceId());
